  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-gray-100 text-gray-900 hover:bg-gray-200 dark:bg-white/15 dark:text-gray-100 dark:hover:bg-white/20",
        destructive: "border-transparent bg-red-600 text-white hover:bg-red-700",
        outline: "border-gray-300 text-gray-900 dark:border-white/20 dark:text-gray-100",
      },
    },
    defaultVariants: {
      variant: "default",
