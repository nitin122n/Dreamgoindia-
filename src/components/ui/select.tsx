...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 caret-gray-900 ring-offset-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50 dark:border-white/15 dark:bg-[#0f111a] dark:text-gray-100 dark:ring-offset-[#0f111a] dark:placeholder:text-gray-500 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
